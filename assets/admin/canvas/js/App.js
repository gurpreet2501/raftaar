...
$(function() {
	...
	(function(){
		$('#manage-technician-btn').click(function(){
			$('#manage-technician-model').modal({show:true})
		});
	})();

	try{
		$('#field-start').timepicker({timeFormat: 'h:mm:ss'});
		$('#field-end').timepicker({timeFormat: 'h:mm:ss'});
	} catch(e){}
});