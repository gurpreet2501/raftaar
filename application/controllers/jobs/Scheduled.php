...
class Scheduled extends MY_Controller
{
    public function index()
    {
        ...
        $crud->fields('request_date','time_slot_id' , 'customer_id' ,'contact_name', 'phone' , 'latitude', 'longitude', 'pro_id', 'technician_id', 'service_id', 'service_type',
          'title' ,'customer_notes','job_addresses' ,'job_appliances');            
        
        $crud->callback_field('technician_id','Jobs_helper::tech_dropdown');  
        ...
        //display in order
        $crud->unset_fields('status','locked_on','locked_by','started_at','finished_at','total_cost','updated_at','created_at','warranty');
